...
const (
	defaultPathConfig string = "/etc/worker/config.yml"

	defaultDirLog string = "/var/log/worker"

	defaultServerINETHost string = "0.0.0.0"
	defaultServerINETPort int    = 8000
	defaultServerUNIXAddr string = "/run/worker/worker.sock"
